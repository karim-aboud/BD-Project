...
--LesAdresses(_IDadresse,noRue, nomRue, ville, CodePostal, _IDclient);


INSERT INTO LesAdresses VALUES (1, 16, 'Rue Gustave Eiffel', 'Paris', '91130', 1);
...
--LesPages(IDpage, IDimpress noPage, MiseEnForme);

INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(11,1,1,'<nth>'); 
INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(12,1,2,'<nth>');
INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(13,1,3,'<nth>');
INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(21,2,1,'<nth>');
INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(31,3,1,'<nth>');
INSERT INTO LesPages(IDpage,IDimpress,noPage,MiseEnForme) VALUES(41,4,1,'<nth>');


--LesPhotos(IDpage, CheminAcces, parametres, textDescrip);

INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (1, 11,'img/chien.png','mon chien');
INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (2, 11, 'img/ciel.png', 'Photo du ciel');
INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (3, 12, 'img/soleil.png', 'le soleil');
INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (4, 13, 'img/ann2020.png', 'annee 2020');
INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (5, 21, 'img/world.png', 'planete');
INSERT INTO LesPhotos(IDphoto, IDpage, CheminAcces, textDescrip) VALUES (6, 31, 'img/chat.png', 'mon chat');


--LesAlbums(IDimpress, refrce, titre, couverture);

INSERT INTO LesAlbums VALUES (1, '15x21ALB', 'Bonjour', 12);
